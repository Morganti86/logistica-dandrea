    ...
    <section className={style.datosContacto}>
      <div className={style.contactoBox}>
        ...
        <div className={style.label}>
          ...
          <a href="tel:+5491163968564" className={style.info}>
            11-6396-8564
          </a>
        </div>
      </div>
      ...
      <div className={style.contactoBox}>
        ...
        <div className={style.label}>
          ...
          <a
            href="https://wa.me/5491163968564"
            target="_blank"
      ...
      <div className={style.contactoBox}>
        ...
        <div className={style.label}>
          ...
          <a
            href="mailto:contacto@logisticadandrea.com.ar"
            className={style.info}
          >
            contacto@logisticadandrea.com.ar
          </a>
        </div>
      </div>
